...
ACCOUNT_EMAIL_VERIFICATION = 'optional'         # No email verification � log in immediately after signup
...
# Email backend — uses Gmail SMTP in production, console in development
...
DEFAULT_FROM_EMAIL = os.getenv('EMAIL_HOST_USER', 'noreply@ourhome.in')
